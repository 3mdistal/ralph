...
describe("State SQLite (~/.ralph/state.sqlite)", () => {
  test("migrates schema from v3", () => {
    ...
    try {
      ...
      expect(taskColumnNames).toContain("checkpoint");
      expect(taskColumnNames).toContain("checkpoint_seq");
      expect(taskColumnNames).toContain("pause_requested");
      expect(taskColumnNames).toContain("paused_at_checkpoint");
  ...
  test("migrates schema from v7", () => {
    ...
    try {
      ...
      expect(columnNames).toContain("checkpoint_seq");
      expect(columnNames).toContain("pause_requested");
      expect(columnNames).toContain("paused_at_checkpoint");
